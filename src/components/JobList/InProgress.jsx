        ...
        <div key={job.id}>
          <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 gap-6">
            <div className="rounded">
              <div className="h-60 overflow-auto w-200 flex flex-col justify-between dark:bg-gray-800 bg-pink dark:border-gray-700 rounded-lg border-2 border-gray-400 mb-6 py-5 px-4 hover:bg-pinkcard hover:border-gunmetal">
                <div>
